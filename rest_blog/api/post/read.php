...
//1 - nao foi enviado um id, mostra todos os posts - read()  feito
//2 - foi enviado um id de post, mostra os dados daquele post - read(id) feito
//3 - foi enviado um id de categoria, mostra os posts da categoria - readByCat(idcat)	    
		...
		if(isset($_GET['id'])){
	    	...
	    	$resultado = $post->readByCat($_GET['id_categoria']);
	   	}else{
	   		$resultado = $post->read();
	   	}
